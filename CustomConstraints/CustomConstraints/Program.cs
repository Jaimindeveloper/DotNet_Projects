using CustomConstraints.CustomConstraints;

var builder = WebApplication.CreateBuilder(args);

builder.Services.AddRouting(options =>
{
    options.ConstraintMap.Add("customConstraint", typeof(CustomConstraintsClass));
});
...
app.UseEndpoints(endpoints =>
{
    ...
    endpoints.MapGet("/countries/{countryID:int:customConstraint}", async context =>
    {
